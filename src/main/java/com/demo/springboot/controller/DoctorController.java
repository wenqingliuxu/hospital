...
//                e.printStackTrace();
    ...
    @RequestMapping(value = "/xinNeiKe",method = RequestMethod.POST)
    @ResponseBody
    public List<Doctor> getxnkDeptDoctor(String deptId,HttpSession session){
        String depId = (String) session.getAttribute("depId");
        List<Doctor> doctorList = doctorService.getDocByDepartment(depId);
        return doctorList;
    }
    ...
    @RequestMapping(value = "/ganRanNeiKe",method = RequestMethod.POST)
    @ResponseBody
    public List<Doctor> getDeptDoctor(String deptId,HttpSession session){
        String depId = (String) session.getAttribute("depId");
        logger.info(deptId);
        List<Doctor> doctorList = doctorService.getDocByDepartment(depId);
    ...
    @RequestMapping(value = "/erKe",method = RequestMethod.POST)
    @ResponseBody
    public List<Doctor> geterDeptDoctor(String deptId,HttpSession session){
        String depId = (String) session.getAttribute("depId");
        logger.info(deptId);
        List<Doctor> doctorList = doctorService.getDocByDepartment(depId);
        logger.info(doctorList);
    ...
    @RequestMapping(value = "/shenJingKe",method = RequestMethod.POST)
    @ResponseBody
    public List<Doctor> getersjkDeptDoctor(String deptId,HttpSession session){
        String depId = (String) session.getAttribute("depId");
        logger.info(deptId);
        List<Doctor> doctorList = doctorService.getDocByDepartment(depId);
        logger.info(doctorList);
    ...
    @RequestMapping(value = "/linChuangYY",method = RequestMethod.POST)
    @ResponseBody
    public List<Doctor> getelcyyDeptDoctor(String deptId,HttpSession session){
        String depId = (String) session.getAttribute("depId");
        logger.info(deptId);
        List<Doctor> doctorList = doctorService.getDocByDepartment(depId);
        logger.info(doctorList);
